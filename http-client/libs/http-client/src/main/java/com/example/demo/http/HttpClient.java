 ...
 * It can cancel both sync/async requests, add interceptors and show progress of operations.
 */
public class HttpClient {
    ...
    /**
     * This sets a basic Authorization header for Http requests with username and password.
     */
    ...
    /**
     * This prepares request from request builder and client from client builder and then sends
    ...
    /**
     * This prepares request from request builder and client from client builder and then sends
     * a sync request and returns {@link java.util.concurrent.CompletableFuture} response
     */
    ...
    /**
     * This sets a Network Interceptor and prints the progress of a request using a {@link com.example.demo.http.progress.ProgressListener}.
     */
    ...
    /**
     * This sets basic authorization for Http client and uses those credential only if required for a resource.
     */
